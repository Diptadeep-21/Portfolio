...
export default function About() {
  const traits = [
    ...
    { label: "Precision problem solving", body: "477 DSA problems have sharpened the way I approach algorithmic challenges — optimal before correct." },
  ...
  const journey = [
    ...
    { year: "2024", event: "Delivered 5+ full-stack production systems; reached 477 DSA" },
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <div className="about-left">
              ...
              <div className="about-body-cols">
                ...
                <br /><br />
                The discipline comes from consistent practice: 477 data structures and algorithms problems have shaped how I think about efficiency, edge cases, and system behaviour under load. That rigor carries into every project I ship.
              </div>
            ...
            <div className="about-right">
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                {[
                  ...
                  { num: "477", label: "DSA Problems", desc: "LeetCode & beyond" },
              ...
              <div className="timeline">
                ...
                {[
                  ...
                  { year: "2024", event: "Built 5+ full-stack systems; hit 477 DSA" },
